...
import emailService, { EmailFilters, EmailMessage } from '@/services/email.service'
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{(stats?.failed || 0) + (stats?.bounced || 0)}</div>
          <p className="text-xs text-muted-foreground">
...
function SendEmailDialog() {
  ...
  const sendMutation = useMutation({
    mutationFn: (data: { to: string; toName?: string; subject: string; html: string }) =>
        ...
        <div className="space-y-4 max-h-[70vh] overflow-y-auto">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              {emailMsg.recipient_name && (
                <p className="text-sm text-muted-foreground">{emailMsg.recipient_name}</p>
              )}
            </div>
            <div>
          ...
          <div>
            ...
            <div 
              ...
              dangerouslySetInnerHTML={{ __html: emailMsg.body_html || emailMsg.body_text || '' }}
            />
          </div>
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              View and manage emails sent to customers.
            </CardDescription>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Emails will appear here when orders are placed.
            </p>
            <SendEmailDialog />
          </div>
        ) : (
                    ...
                    <TableRow key={emailMsg.id}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-1">
                          ...
                          {(emailMsg.status === 'failed' || emailMsg.status === 'bounced') && (
                            <Button
                              variant="ghost"
                              size="sm"
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="font-medium">
                {isConfigured ? 'Email is configured' : 'Email needs configuration'}
              </p>
              <p className="text-sm text-muted-foreground">
          ...
          {!isConfigured && (
            <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <p className="text-sm text-yellow-700 mb-3">
                To enable email notifications, add these environment variables to your server:
              </p>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage emails sent to customers for order updates and notifications.
          </p>
        </div>
      </div>
