...
const reasonContent: Record<CancelReason, ReasonContent> = {
  user_cancelled: {
    ...
    description:
      "You've cancelled the payment. Your items are still in your cart.",
  ...
  payment_failed: {
    ...
    description:
      'We could not process your payment. Please try again with a different payment method.',
  ...
  expired: {
    ...
    description:
      'Your checkout session has expired. Please start the checkout process again.',
  ...
  unknown: {
    ...
    description:
      "We couldn't complete your order. Don't worry - no payment was processed.",
...
export default function PaymentCancelPage() {
  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 via-white to-orange-50 py-12'>
      <div className='max-w-2xl mx-auto px-4 sm:px-6'>
        ...
        <div className='bg-white rounded-2xl shadow-xl overflow-hidden'>
          ...
          <div className={`px-6 py-12 text-center ${content.bgColor}`}>
            <div
              className={`inline-flex items-center justify-center w-24 h-24 bg-white rounded-full mb-6 shadow-lg ${content.color}`}
            >
              {content.icon}
            </div>
          ...
          <div className='p-6 sm:p-8'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              ...
              >
                ...
                <span className='text-xs text-gray-500'>Mon-Fri 9-6</span>
              </Link>
            </div>
          </div>
        </div>
